...
par17 <- read.MFCLPar("z:/yft/2017/assessment/Model_Runs/For_Web/14.par")
par20 <- read.MFCLPar("z:/yft/2020/assessment/ModelRuns/Diagnostic/14.par")
...
# Plot M
plot.nat.mort(list(Diag20=Diag20, Diag17=Diag17))

# Plot maturity
plot.maturity(list(Diag20=par20, Diag17=par17))
