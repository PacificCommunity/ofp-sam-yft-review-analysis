...
penguin <- "z:/yft/2020/assessment/ModelRuns/Stepwise"

# read 2020 stepwise 'SelUngroup' (main)
untar(file.path(penguin, "Step9SelChange/End.tar.gz"), "plot-14.par.rep")
step10_SelUngroup <- read.MFCLRep("plot-14.par.rep")
file.remove("plot-14.par.rep")

# read 2020 stepwise 'SelUngroup' A
untar(file.path(penguin, "Step9aUngroupSel/End.tar.gz"), "plot-14.par.rep")
step10a_SelUngroup <- read.MFCLRep("plot-14.par.rep")
file.remove("plot-14.par.rep")

# read 2020 stepwise 'SelUngroup' B
untar(file.path(penguin, "Step9bUngroupAsym/End.tar.gz"), "plot-14.par.rep")
step10b_SelUngroup <- read.MFCLRep("plot-14.par.rep")
file.remove("plot-14.par.rep")

# read 2020 stepwise 'SelUngroup' C
untar(file.path(penguin, "Step9cUngroupAsymAge2/End.tar.gz"), "plot-14.par.rep")
step10c_SelUngroup <- read.MFCLRep("plot-14.par.rep")
file.remove("plot-14.par.rep")

# read 2020 stepwise 'SelUngroup' AA
step10aa_SelUngroup <- read.MFCLRep(file.path(penguin, "Step9aaNoAge0Ungroup/plot-10.par.rep"))
